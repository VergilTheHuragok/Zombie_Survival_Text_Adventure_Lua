...
space = 10
pain = 0
epipen = 0-----pain killers
creator = "n"
events = 0
painkillers = 0---morphine
broken = "n"
temperature = 42
cold = "n"
store = "n"
...
print("Which slot?")
  ...
  gunstorethree = mygunthree
   ...
   want = io.read()
   if want == "y" then
   print("Slot 1 = "..gunstoreone..", slot 2 = "..gunstoretwo..", slot 3 = "..gunstorethree..", or \"4\" for cancel.")
...
print("You found some meat.")
   ...
   repeat
   if food < 500 then
    meat = 100--as long as its not less than 2
   usemeat()
   meat = 0
  ...
  break
   ...
   print("You are not hungery.")--Fixed
   io.read()
   break
   end
   until useamount == 0
     if store == "y" then
   meatstore = useamount--------------Already done
   end
   useamount = 0
   print("You leave.")
   io.read()
...
if watch == "n" then
   ...
   print("You already have a "..watchcolor.." watch.")----Already Done
...
function optionline()
print("___________________________")---------------------------------------Write stats
   repeat
   use = io.read()
   if use == "d" then
   dropped()
   ...
   print("Section 1:INFORMATION, Section 2:STATS, Section 3:WEAPON, Section 4:DOGS, Section 5:ITEMS, Section 6:INJURIES, Section 7:OUTFIT, all:All Sections.")
   choose = io.read()
   if choose == "1" then
   if statA == "n" then
   statA = "y"
...
print("You found a bottle of water.")
  ...
  break
   ...
   print("You are not thirsty.")--Fixed
   io.read()
   break
   end
   print("You leave.")
...
function help()
repeat
print("Section 1:GAME HELP, Section 2:QUESTION HELP, Section 3:STAT HELP, Section 4:INFORMATION HELP, Section 5:WEAPON HELP")
print("Section 6:ITEM HELP, Section 7:INJURY HELP, Section 8:OUTFIT HELP, Section 9:SPAWN HELP, Section 10:EVENT HELP")
print("Section 11:ACTION HELP, Section 12:OPTION HELP, Section 13:GAMEMODE HELP")
print("Please type the number of the section you want to view and hit ENTER or RETURN. Or just hit ENTER or RETURN to leave the help section.")
section = io.read()
if section == "1" then
print("GAME HELP")
print("This game randomly chooses from a list of different events to occur, after each event, it will show a line.")
print("To view your stats type \"s\" after you see the line.")
print("After an event or message, press ENTER or RETURN to continue. Or if you just need to enter a word.")
...
print("In options, you can choose to have your stats automaticly displayed, to search your stats, and what sections of stats to view.")
print("See GAMEMODE HELP for gamemodes, INFORMATION HELP for accuracy (time of day), ITEM HELP for watches, or OPTION HELP for options.")
io.read()
...
print("If you don't have room for an item, you will automaticly be asked to drop something and then use something, just hit enter to cancel.")
print("To drop an item, type \"d\" after you see the line. Then type the item's name with all lower case in singular form.")
print("To use an item, type \"u\" after you see the line. Then type the item's name with all lower case in singular form.")
io.read()
...
print("It takes up 1 space.")
print("When you die of blood, you have 1/3 of a chance a player will use an epi-pen on you if you have one.")
...
print("It takes exhaustion every time you travel to your teent but you can put anything in and take anything out of it.")
...
print("If you still don't have enough blood but have a blood bag, he will then give you a blood tranfusion.")
...
print("You can find bloodbags, knives, tents, bottles, jerry cans, bandaids, painkillers, morphine, heat packs, matches, beans, pop, and road flares.")
print("See ITEM HELP for items.")
io.read()
...
print("You can find an AS50 in the tent, NV goggles, smoke grenades, grenades, gillie suits, and the Coyote pack.")
print("The Millitary campsite will sometimes have a guard, which is really hard to kill.")
print("The guard can drop 6 items which are smoke grenades, grenades, G36C, gillie suits, AK47, and an FN FAL.")
...
print("When your dogs run out of health, only one dies. When they run out of food or water, they all die.")
...
io.read()
print("To view stats type \"s\", to use type \"u\", to drop type \"d\", to jog type \"j\", type \"o\" for options, and to rest type \"r\".")
print("Jogging raises your temperature and resting lowers your exhaustion and switches between night and day.")
...
print("Stat Seach lets you look at sections of your stats individually. (Useful if stats are running out of your screen.)")
...
print("GAMEMODE HELP")
print("The recruit gamemode gives you all the medical supplies, a road flare, a bottle of water, a revolver, a Vest Pouch, and 5 steak. You have 22,000 health.")
...
elseif words == 4 then
writing = "If my family finds this, I'm already dead. I attached my will to the following page...I wish you the best."
elseif words == 5 then
...
print("Section 1:INFORMATION, Section 2:STATS, Section 3:WEAPON, Section 4:DOGS, Section 5:ITEMS, Section 6:INJURIES, Section 7:OUTFIT, or \"all\" for all.")
want = io.read()
if want == "1" then
stats1()
elseif want == "2" then
...
playerevent()
   ...
   print("You found a "..vehiclename..", use it?.")----------Vehicle
   fix = io.read()
   if fix == "y" then
   if cfilled == "y" then
...
guarddrop()
	  ...
	  pain = pain + math.random(2000,5000)
               print("The player guard killed you.")--------------------------Die
               health = 0
               health = health - math.random(1000,8000)
			   break
            end--myammo
